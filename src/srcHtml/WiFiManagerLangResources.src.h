...
const char WM_PK_INDEX_HTML_PART1[] PROGMEM = "%WM_PK_INDEX_HTML_PART1%";
const char WM_PK_INDEX_HTML_PART2[] PROGMEM = "%WM_PK_INDEX_HTML_PART2%";
const char WM_PK_SETTINGS_HTML_PART1[] PROGMEM = "%WM_PK_SETTINGS_HTML_PART1%";
const char WM_PK_SETTINGS_OPT_BTNS[] PROGMEM =
...
#endif
    "";
const char WM_PK_SETTINGS_HTML_PART2[] PROGMEM = "%WM_PK_SETTINGS_HTML_PART2%";
