...
// To enable/dissable MQTT support from plaformio.ini
#ifndef WM_SUPPORT_MQTT
  #define WM_SUPPORT_MQTT false
#endif

// To enable/dissable train control support from plaformio.ini
#ifndef WM_SUPPORT_TRAIN_CONTROL
  #define WM_SUPPORT_TRAIN_CONTROL false
#endif
...
const char WM_PK_EMPTY_STR[] PROGMEM = "";
...
public:
    ...
    void          setAPCallback(std::function<void(ESPAsync_WiFiManager*)>);
...
////////////////////////////////////////////////////
    ...
    void setHostname()
    {
        if (_RFC952_hostname[0] != 0)
        {
            #if ESP8266      
                WiFi.hostname(_RFC952_hostname);
            #else
...
private:
    ...
    void          init(const char *iHostname);
    ...
    void          handleTrainControl(AsyncWebServerRequest *request);
#endif
...
private:
    // PK: Private member variables
    AsyncDNSServer          *_dnsServer = nullptr;
    AsyncWebServer          *_server = nullptr;
    bool                    _isSTAmode = false; // PK true if STA mode is active, false if AP is active
    bool                    _modeless = false;
    int                     _scannow = -1;
    int                     _shouldscan = true;
    bool                    _needInfo = true;
    String                  _pager;
    wl_status_t             _wifiStatus;

#define RFC952_HOSTNAME_MAXLEN      24
    char                    _RFC952_hostname[RFC952_HOSTNAME_MAXLEN + 1];
    ...
    int                    *_networkIndices = nullptr;
    WiFiResult             *_wifiSSIDs = nullptr;
    wifi_ssid_count_t       _wifiSSIDCount;
    bool                    _wifiSSIDscan = true;
    ...
    bool                    _connect;
    bool                    _stopConfigPortal = false;
    bool                    _debug = false;     //true;
    
    std::function<void(ESPAsync_WiFiManager*)> _apcallback = NULL;
    std::function<void()>   _savecallback = NULL;
    ...
    // member variables used for OTA update
